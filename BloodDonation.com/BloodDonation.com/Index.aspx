<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="BloodDonation.com.Index" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body chat-widget-main">
                    ...
                    <div class="chat-widget-left">
                        The blood you donate gives someone abother chance at life.
                    </div>
                    <br />
                    ...
                    <br />
                    <div class="chat-widget-name-right">
                        <img class="media-object img-circle img-left-chat cimg" src="assets/img/amit.png" /><br />
    ...
    <div id="d2">
            ...
            <div class="d1">
                <a href="SignIn.aspx">
                <img src="assets/img/1d.PNG" class="img2" />    </a>
            </div>    
            <div class="d1">
                <a href="SignIn.aspx">
                <img src="assets/img/rq.PNG" class="img2" />    </a>
            </div>
            <div class="d1">
                <a href="SignIn.aspx">
                <img src="assets/img/d2.PNG" class="img2" />    </a>
            </div>
            <div class="d1">  
                <a href="SignIn.aspx">
                <img src="assets/img/d4.PNG" class="img2" />    </a>
            </div>
