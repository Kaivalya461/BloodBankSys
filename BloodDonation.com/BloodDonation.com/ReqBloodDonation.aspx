<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.Master" AutoEventWireup="true" CodeBehind="ReqBloodDonation.aspx.cs" Inherits="BloodDonation.com.ReqBloodDonation" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="container1">
        <div>
            <asp:Image ID="Images" runat="server" CssClass="i1" />
        </div>
